...
// Ensure you have run: npm install @supabase/supabase-js
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMessage = { 
        ...
        role: 'assistant', 
        content: "I'm having trouble connecting. Please check your internet or API keys.", 
        createdAt: new Date() 
      }
...
export default function ChatPage() {
  ...
  // Using the core client as a safe fallback
  ...
  // 1. Authentication & Retrieve History
  useEffect(() => {
    ...
    <div className="flex h-screen flex-col bg-[#efeae2]">
      ...
      <header className="flex items-center justify-between bg-[#008069] p-4 text-white shadow-md z-10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold">Agent Smith</h1>
